...
class TokenRequestSchema(object):
    ...
    def additional_values(self):
        """Gets the additional_values of this TokenRequestSchema.  # noqa: E501

        Additional values to be included in the token  # noqa: E501

        :return: The additional_values of this TokenRequestSchema.  # noqa: E501
    ...
    def additional_values(self, additional_values):
        """Sets the additional_values of this TokenRequestSchema.

        Additional values to be included in the token  # noqa: E501

        :param additional_values: The additional_values of this TokenRequestSchema.  # noqa: E501
