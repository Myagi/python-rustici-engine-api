...
class RegistrationSchema(object):
    ...
    def __init__(self, id=None, instance=None, xapi_registration_id=None, dispatch_id=None, updated=None, registration_completion='UNKNOWN', registration_success='UNKNOWN', score=None, total_seconds_tracked=None, first_access_date=None, last_access_date=None, completed_date=None, created_date=None, course=None, learner=None, global_objectives=None, activity_details=None, shared_data=None, suspended_activity_id=None, registration_completion_amount=None):  # noqa: E501
    ...
    def registration_completion(self, registration_completion):
        ...
        if registration_completion not in allowed_values:
            raise ValueError(
                "Invalid value for `registration_completion` ({0}), must be one of {1}"  # noqa: E501
                .format(registration_completion, allowed_values)
            )
    ...
    def registration_success(self, registration_success):
        ...
        if registration_success not in allowed_values:
            raise ValueError(
                "Invalid value for `registration_success` ({0}), must be one of {1}"  # noqa: E501
                .format(registration_success, allowed_values)
            )
